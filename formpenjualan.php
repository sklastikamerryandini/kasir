...
<form action="inputpelanggan.php" style="max-width:500px;margin:auto" method="POST">
  <h2>Form Penjualan</h2>
  <div class="input-container">
    <i class="fa fa-calendar icon"></i>
    <label class="input-field">Tanggal Penjualan</label>
    <input class="input-field" type="text" placeholder="Pilih Tanggal" name="tanggal">
  </div>
  ...
  <div class="input-container">
    ...
    <select class="input-field" name="namapelanggan">
      ...
      while ($data = mysqli_fetch_array($query)) {
        echo "<option value = $data[PelangganID]</option>";
      }
      ?>
      </select>
  </div>
  ...
  <button type="text" class="btn"><a href="dashboardadmin.html">Batal</button>
</form>
